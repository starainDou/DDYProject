...
@implementation DDYAudioChangeManager
...
- (id)initWithConfig:(DDYAudioChangeConfig)myConfig audioData:(NSData *)myData target:(id)myTarget action:(SEL)myAction {
    if (self = [super init]) {
        target = myTarget;
        action = myAction;
        config = myConfig;
