...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        [self updateTitleLabelWithTitle:@"按住说话"];
...
- (void)setVoiceState:(DDYVoiceState)voiceState {
    ...
    switch (voiceState) {
        ...
        case DDYVoiceStateClickRecord:
            [self updateTitleLabelWithTitle:@"点击录音"];
            break;
        case DDYVoiceStateTouchChangeVoice:
             [self updateTitleLabelWithTitle:@"按住变声"];
            break;
        case DDYVoiceStateListen:
             [self updateTitleLabelWithTitle:@"松手试听"];
            break;
        case DDYVoiceStateCancel:
             [self updateTitleLabelWithTitle:@"松手取消发送"];
            break;
        case DDYVoiceStateSend:
            break;
        case DDYVoiceStatePrepare:
             [self updateTitleLabelWithTitle:@"准备中"];
...
#pragma mark 结束录音
- (void)endRecord {
    [DDYRecordModel shareInstance].path = [DDYFileTool ddy_RecordPath];
